...
class DBSQLSession {
    ...
    async executeStatement(statement, options = {}) {
        ...
        const operationPromise = driver.executeStatement({
            ...
            canDownloadResult: (_a = options.useCloudFetch) !== null && _a !== void 0 ? _a : clientConfig.useCloudFetch,
            parameters: getQueryParameters(options.namedParameters, options.ordinalParameters),
            canDecompressLZ4Result: clientConfig.useLZ4Compression && Boolean(utils_1.LZ4),
        });
        const response = await this.handleResponse(operationPromise);
